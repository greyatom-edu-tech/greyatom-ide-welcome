            ...
            <div className='row'>
              <div className='col-sm-12'>
                ...
                <table className='table'>
                  ...
                  <tbody>
                    <tr>
                      <td className='keyboard-shortcut'>CMD+I</td>
                      <td>Toggle Terminal</td>
                      <td>Description about the shortcut</td>
                    </tr>
                    <tr>
                      <td className='keyboard-shortcut'>CTRL+ALT+O</td>
                      <td>Toggle File-Tree</td>
                      <td>Description about the shortcut</td>
                    </tr>
                    <tr>
                      <td className='keyboard-shortcut'>CMD+O</td>
                      <td>Search Project</td>
                      <td>Description about the shortcut</td>
                    </tr>
                    <tr>
                      <td className='keyboard-shortcut'>CMD+P</td>
                      <td>Search File</td>
                      <td>Description about the shortcut</td>
                    </tr>
                  </tbody>
