...
export default class SettingsView {
  ...
  initializePanels () {
    ...
    this.addCorePanel('Overview', 'settings', () => new OverviewPanel({
      showProjects: () => {
        this.showPanel('Projects')
      }
    }))
    this.addCorePanel('Projects', 'code', () => new ProjectsPanel({
      projects: [],
    }))
    this.addCorePanel('Shortcuts', 'code', () => new ShortcutsPanel())
