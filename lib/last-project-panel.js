...
export default class LastProjectPanel {
  ...
  renderLastProject() {
    ...
    let nameOfLastProject = 'You seem to be new to Commit Live IDE, click the View Projects button given below to work on you first project!'
    if (lastProject) {
    ...
    return (
      <div className='panel panel-info last-viewed'>
        ...
        <div className='panel-body'>
          ...
          <div className='activity-btn' ref='continueBtn'>
